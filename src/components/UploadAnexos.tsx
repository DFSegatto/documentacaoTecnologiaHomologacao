    ...
    <div className="space-y-3">
      ...
      {erros.length > 0 && (
        <div className="space-y-1">
          {erros.map((e, i) => (
            <p key={i} className="text-xs text-red-600 bg-red-50 px-3 py-2 rounded-lg flex items-start gap-2">
            ...
            <div key={a.url} className="flex items-center gap-3 bg-white border border-gray-100 rounded-lg px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <a href={a.url} target="_blank" rel="noopener noreferrer"
                  className="text-sm text-gray-700 hover:text-brand-600 truncate block">{a.nome}</a>
                {a.tamanho > 0 && (
